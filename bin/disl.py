    ...
    try:
        with open(os.devnull, "w") as devnull:
            with open(pid_file_name, "r") as pid_file:
                ...
                Popen(["kill", pid], stdout=devnull, stderr=devnull, shell=False)
    except IOError:
        pass
...
def run_client(args, parser):
    ...
    graal = args.disl_home+"/lib/graal-external.jar"
    ...
    if args.cse == True:
        c_cmd+= ["-Xbootclasspath/a:"+bypass+":"+args.instrumentation+":"+graal+":"+dispatch]
    else:
